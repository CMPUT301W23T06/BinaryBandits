...
public class ScannerController {
     ...
     * @param resultOfScan
     */
    public void addQRCode(Player player, Result resultOfScan) {
        String contents = resultOfScan.getText();
        String hash = getHash(contents);
        String name = generateUniqueName(hash);
        int points = calculatePoints(hash);
        String visualRep = generateUniqueVisualRep(hash);
